...
const Nav = () => {
  ...
  const navClass = (url) => {
    return classNames(
      {
        'text-gray-300': router.asPath !== url,
        'hover:bg-gray-700': router.asPath !== url,
        'hover:text-white': router.asPath !== url,
        'bg-gray-900': router.asPath === url,
        'text-white': router.asPath === url,
      },
      'px-3',
      'py-2',
      'rounded-md',
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                <Link href="/">
                  <a className={navClass('/')}>Dashboard</a>
                </Link>
                <Link href="/home">
                  <a className={navClass('/home')}>Home</a>
                </Link>
                <Link href="/about">
                  <a className={navClass('/about')}>About</a>
                </Link>
                <Link href="/blog">
                  <a className={navClass('/blog')}>Blog</a>
                </Link>
                <Link href="/reports">
                  <a className={navClass('/reports')}>Reports</a>
                </Link>
              </div>
            </div>
          </div>
